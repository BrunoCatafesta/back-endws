...
public class TestProductRepository {
	...
	public void mustPersistProductWithAllFields() {
		...
		Manufacturer manufacturer = new ManufacturerBuilder().withName(nameManufacturerExpected).builde();
		manufacturerRepository.insert(manufacturer);

		Product product = new ProductBuilder().withName(nameProductExpected).withBarcode(barcodeProductExpected)
				.withDescription(descriptionProductorExpected).withManufacturer(manufacturer).builde();
